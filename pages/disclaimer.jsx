            ...
            <section className="disclaimer py-85px px-15px xl:px-0">
                <div className="max-w-1140px mx-auto">
                    <div className="disclaimer-inner max-w-4xl mx-auto">
                        ...
                        <p className="text-lg font-nunito text-black">The information provided by Cybertrace Pty Ltd. (“we,” “us”, or “our”) on https://www.www.cybertrace.com.au (the “Site”) and our mobile application is for general informational purposes only. All information on the Site and our mobile application is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability or completeness of any information on the Site or our mobile application . 
                        ...
                        <p className="text-lg font-nunito text-black">The Site and our mobile application may contain (or you may be sent through the Site or our mobile application ) links to other websites or content belonging to or originating from third parties or links to websites and features in banners or other advertising. Such external links are not investigated, monitored, or checked for accuracy, adequacy, validity, reliability, availability or completeness by us.
                        ...
                        <p className="text-lg font-nunito text-black">The Site and our mobile application may contain links to affiliate websites, and we receive an affiliate commission for any purchases made by you on the affiliate website using such links. Our affiliates include the following:</p>
                        <li className="text-lg font-nunito text-black">ScamAdviser</li>
                        <li className="text-lg font-nunito text-black">Google AdWords</li>
                    </div>
                </div>
            </section>
