                ...
                <div className="gap-5 justify-between lg:flex">
                    ...
                    <div className="mx-auto bg-black px-25px py-10 text-center rounded-lg mb-5 lg:mb-0 lg:w-2/5">
                        ...
                        <div className="text-center">
                            <Link href="#">
                                <a className="transition-all text-base font-roboto font-medium capitalize tracking-wider bg-golden text-white px-8 py-3 inline-flex items-center justify-center rounded-full mt-10 border border-golden hover:bg-transparent hover:border hover:border-golden hover:text-golden">check Website</a>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="mx-auto bg-black px-25px py-10 rounded-lg lg:w-3/5">
                        ...
                        <div className="text-center">
                            <Link href="#">
                                <a className="text-base font-roboto font-medium tracking-wider capitalize bg-golden text-white px-8 py-3 inline-flex items-center justify-center mt-10 border border-golden rounded-full hover:bg-transparent hover:border hover:border-golden hover:text-golden">
                                    Learn more</a>
                            </Link>
                        </div>
                    </div>
