        ...
        <section className="py-85px px-15px xl:px-0">
            <div className="max-w-1140px mx-auto">
                ...
                <div className="gap-5 justify-between md:flex">
                    ...
                    <div className="mx-auto bg-black px-25px py-10 text-center rounded-lg mb-5 md:mb-0 md:w-2/5">
                    ...
                    <div className="mx-auto bg-black px-25px py-10 rounded-lg md:w-3/5">
