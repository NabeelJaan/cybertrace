            ...
            <div className="max-w-1140px mx-auto">
                <div className="box-wrapper flex gap-x-6">
                    <div className="box p-50px bg-black rounded-2xl text-center w-2/6">
                        ...
                        <p className="text-base font-normal font-nunito text-white">Our Executive have been full-time employees of Australian State and Federal governments.
                    ...
                    <div className="box p-50px bg-black rounded-2xl text-center w-2/6">
                        ...
                        <p className="text-base font-normal font-nunito text-white">Professionalism is not something that can be learnt, it comes from a willingness to not only serve,
                    ...
                    <div className="box p-50px bg-black rounded-2xl text-center w-2/6">
                        ...
                        <p className="text-base font-normal font-nunito text-white">Our Executive have proven untainted integrity and insist on the same qualities from our staff and contractors.
