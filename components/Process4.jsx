            ...
            <div className="max-w-1140px mx-auto">
                ...
                <div className="pb-wrapper grid md:grid-flow-row md:grid-cols-2 md:grid-row-2 gap-5 mt-12">
                    <div className="pro-box bg-golden px-25px py-10 text-center rounded-md">
                        ...
                        <p className="text-white text-base font-nunito font-normal">We believe that ethics and integrity are the backbone of any quality company.
                    ...
                    <div className="pro-box bg-golden px-25px py-10 text-center rounded-md min">
                        ...
                        <p className="text-white text-base font-nunito font-normal">Our CEO and Founder, Dan Halpin has a reputation as a leading innovator in the
